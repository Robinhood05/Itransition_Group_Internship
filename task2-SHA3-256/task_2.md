...
Sort hashes in the ascending order of the product of hex digits increased by one (for example, for the hash 63a6ba9e5de66b11ad6c6d3d1b39a5456f65f918fde6250565e365d89a5196c6 the sorting key is 71365623100112242680609229940949951316513259520000000000).Join sorted hashes without any separator (not keys used for sorting, but hashes themselves).
...
Note: SHA3-256 is not the same algorithm as SHA-256.Some additional hints:
...
DEADLINE: this Friday, 28.11 (it's possible to submit several solutions, only the proper one counts).
